...
--------------------------------------------------------
CREATE UNIQUE INDEX erp_gl_pending_detail_pk ON erp_gl_pending_detail (batch_id, batch_tran_id, gl_acct_id)
/
--------------------------------------------------------
--  Constraints for Table ERP_GL_JOURNAL_DETAIL
--------------------------------------------------------
ALTER TABLE erp_gl_pending_detail ADD CONSTRAINT erp_gl_pending_detail_pk PRIMARY KEY (batch_id, batch_tran_id, gl_acct_id)
USING INDEX  ENABLE
/